...
extraHdr.Position = UDim2.new(0, 6, 0, ey)
...
valueDisplayStatus.Position = UDim2.new(0, 6, 0, ey)
...
antiAfkBtn.Parent = extraScroll
Instance.new("UICorner", antiAfkBtn).CornerRadius = UDim.new(0, 5)
ey += 38

local antiAfkStatus = Instance.new("TextLabel")
antiAfkStatus.Size = UDim2.new(1, -12, 0, 12)
antiAfkStatus.Position = UDim2.new(0, 6, 0, ey)
...
antiAfkStatus.TextSize = 9
antiAfkStatus.TextXAlignment = Enum.TextXAlignment.Left
antiAfkStatus.Parent = extraScroll
ey += 18
